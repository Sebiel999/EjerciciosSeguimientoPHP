        ...
        <div class="card mx-5 my-5" style="background-color: #cccccc;">
            <div class="card-header" style="background-color: #556270;">
                <class class="row">
                    ...
                    <div class="col-md-1">
                        <a href="{{ route('genre.create') }}" class="btn btn-primary"><i class="bi bi-plus-circle-fill"></i></a>
                    </div>
                </class>
            </div>
            <div class="card-body">

                <form action="{{ route('genre.index') }}" class="navbar-search" method="GET">
                    ...
                    <tbody>
                        @foreach ($genres as $genre)
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('genre.edit', $genre->genre_id) }}" class="btn btn-warning"><i class="bi bi-pencil-fill"></i></a>

                                    <form action="{{ route('genre.delete', $genre->genre_id) }}" style="display: contents;" method="POST">
                                        @csrf
                                        @method('DELETE')
                ...
                {{ $genres->appends(request()->except('page'))->links('components.customPagination') }}
...
<script type="module">
    ...
    $(document).ready(function() {
        ...
        $('.btnDelete').click(function (event) {
            ...
            Swal.fire({
                title: "!Hold on¡",
                text: "¿Do you really want to delete the genre?",
                icon: "warning",
